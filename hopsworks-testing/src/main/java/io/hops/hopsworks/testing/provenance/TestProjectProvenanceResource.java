...
public class TestProjectProvenanceResource {
  ...
  public Response testExpAddAppId(
    ...
    } catch (MetadataException | DatasetException e) {
      throw new ProvenanceException(RESTCodes.ProvenanceErrorCode.FS_ERROR, Level.INFO, "xattrs persistance exception");
    } finally {
      if(dfso != null) {
