...
@XmlRootElement
public class ProvFootprintFileStateTreeElastic implements ProvTree.Builder<ProvFileStateMinDTO> {
  ...
  @Override
  public void addChild(ProvTree.Builder<ProvFileStateMinDTO> child)
