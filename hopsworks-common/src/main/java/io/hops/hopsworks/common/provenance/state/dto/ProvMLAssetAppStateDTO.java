...
@XmlRootElement
public class ProvMLAssetAppStateDTO {
  ...
  public ProvMLAssetAppStateDTO() {
  }
  
  public static ProvMLAssetAppStateDTO unknown() {
    ProvMLAssetAppStateDTO state = new ProvMLAssetAppStateDTO();
