...
public class ProvTypeDTO {
  ...
  public static ProvTypeDTO.ProvType provTypeFromString(String aux) throws ProvenanceException {
    try {
  ...
  public static ProvTypeDTO.ProvType getProvType(ProvTypeDTO aux) throws ProvenanceException {
