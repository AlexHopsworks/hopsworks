...
import static io.hops.hopsworks.common.provenance.elastic.ProvElasticHelper.fullTextSearch;
...
public class ProvFileQuery {
  ...
  public interface ValParser {
    Object parse(Object o) throws ProvenanceException;
  }
  ...
  public enum FileState implements Field {
    ...
    ML_TYPE(ProvElasticFields.FileBase.ML_TYPE, new MLTypeValParser()),
    ML_ID(ProvElasticFields.FileBase.ML_ID, new StringValParser()),
  ...
  public static Field extractBaseField(String rawField, QueryType queryType) throws ProvenanceException {
    Field field;
    switch(queryType) {
  ...
  public static Field extractFileStateQueryFilterFields(String val) throws ProvenanceException {
    try {
  ...
  public static Field extractFileStateQueryBaseFields(String val) throws ProvenanceException {
    try {
      return FileState.valueOf(val.toUpperCase());
    } catch(NullPointerException | IllegalArgumentException e) {
      //try next
  ...
  public static Field extractFileOpsQueryBaseFields(String val) throws ProvenanceException {
    try {
      return FileOps.valueOf(val.toUpperCase());
    } catch(NullPointerException | IllegalArgumentException e) {
      //try next
  ...
  public static Field extractExpansionAppQueryBaseFields(String val) throws ProvenanceException {
    try {
...
//    }
  ...
  public interface FilterVal {
    void add(Pair<ProvFileQuery.Field, Object> filter) throws ProvenanceException;
  ...
  public static class FilterValInList implements FilterVal {
    ...
    @Override
    public void add(Pair<ProvFileQuery.Field, Object> filter) throws ProvenanceException {
