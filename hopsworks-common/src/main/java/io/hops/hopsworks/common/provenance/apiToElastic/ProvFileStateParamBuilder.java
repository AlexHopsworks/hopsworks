...
import io.hops.hopsworks.common.provenance.elastic.ElasticPaginationChecker;
...
public class ProvFileStateParamBuilder {
  ...
  public ProvFileStateParamBuilder filterByStateField(ProvFileQuery.Field field, String val)
    throws ProvenanceException {
