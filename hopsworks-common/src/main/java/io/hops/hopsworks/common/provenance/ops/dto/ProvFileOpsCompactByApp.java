...
public class ProvFileOpsCompactByApp {
  ...
  public static List<ProvFileOpsCompactByApp> compact(List<ProvOpsElastic> fileOps) {
    ...
    for(ProvOpsElastic fileOp : fileOps) {
      ...
      byFileAndApp.addOp(new CompactOpHit(fileOp.getInodeOperation().name(),
        fileOp.getLogicalTime(), fileOp.getTimestamp(),
