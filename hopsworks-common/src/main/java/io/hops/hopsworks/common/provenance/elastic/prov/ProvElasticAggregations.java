...
import io.hops.hopsworks.common.provenance.elastic.core.ElasticAggregation;
...
public class ProvElasticAggregations {
  ...
  public static AggregationBuilder getAggregationBuilder(Settings settings, ProvAggregations agg)
    ...
    switch(agg) {
      case FILES_IN:
        return filesInABuilder(settings, "files_in", ProvElasticFields.FileBase.INODE_ID);
  ...
  private static AggregationBuilder filesInABuilder(Settings settings, String agg, ProvElasticFields.Field aggField) {
  ...
  private static AggregationBuilder leastActiveByLastAccessedABuilder(Settings settings,
    String agg1, ProvElasticFields.Field agg1Field,
