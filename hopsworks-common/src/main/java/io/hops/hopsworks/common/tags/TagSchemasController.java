...
public class TagSchemasController implements TagSchemasControllerIface {
  @Override
  public void create(String name, String schema) throws NotSupportedException {
    throw new NotSupportedException(RESTCodes.NotSupportedErrorCode.ENTERPRISE_FEATURE, Level.INFO);
  }
  @Override
  public void delete(String name) throws NotSupportedException {
    throw new NotSupportedException(RESTCodes.NotSupportedErrorCode.ENTERPRISE_FEATURE, Level.INFO);
  }
  @Override
  public void delete(TagSchemas tag) throws NotSupportedException {
    throw new NotSupportedException(RESTCodes.NotSupportedErrorCode.ENTERPRISE_FEATURE, Level.INFO);
  }
  @Override
  public Map<String, String> getAll() throws NotSupportedException {
    throw new NotSupportedException(RESTCodes.NotSupportedErrorCode.ENTERPRISE_FEATURE, Level.INFO);
  }
  
  @Override
  public boolean schemaHasNestedTypes(String schema) throws NotSupportedException {
    throw new NotSupportedException(RESTCodes.NotSupportedErrorCode.ENTERPRISE_FEATURE, Level.INFO);
  }
