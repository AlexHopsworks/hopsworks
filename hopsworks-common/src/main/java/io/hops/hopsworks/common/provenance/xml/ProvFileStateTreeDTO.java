...
@XmlRootElement
public class ProvFileStateTreeDTO implements ProvenanceController.BasicTreeBuilder<ProvFileStateElastic> {
  ...
  @Override
  public void addChild(ProvenanceController.BasicTreeBuilder<ProvFileStateElastic> child)
