...
import io.hops.hopsworks.common.provenance.ops.ProvExecution;
...
public class ProvStateMinDTO
  ...
  public ProvStateMinDTO() {}
  
  public ProvStateMinDTO(Long inodeId, String inodeName, Long projectInodeId, Long datasetInodeId,
  ...
  public static ProvStateMinDTO fromFileOp(ProvOpsElastic op, Provenance.MLType mlType) {
    return new ProvStateMinDTO(op.getInodeId(), op.getInodeName(), op.getProjectInodeId(), op.getDatasetInodeId(),
