      ...
      for(Terms.Bucket artifactBucket : artifacts.getBuckets()) {
        ...
        for(Terms.Bucket fileBucket : artifacts.getBuckets()) {
          ...
          if(readFilter != null) {
            ...
            ProvOpsElastic readOp = ProvOpsElastic.instance(hit);
            file.addFirstRead(readOp, readOpHits.getHits().getTotalHits().value);
          ...
          if(appendFilter != null) {
            ...
            ProvOpsElastic appendOp = ProvOpsElastic.instance(hit);
            file.addFirstAppend(appendOp, appendOpHits.getHits().getTotalHits().value);
