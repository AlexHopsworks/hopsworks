...
public class TrainingDatasetService {
  ...
  public Response createTrainingDataset(@Context SecurityContext sc, TrainingDatasetDTO trainingDatasetDTO)
    throws DatasetException, HopsSecurityException, ProjectException, FeaturestoreException, ProvenanceException {
  ...
  public Response updateTrainingDataset(
    ...
    TrainingDatasetDTO trainingDatasetDTO)
    throws FeaturestoreException, DatasetException, ProjectException, HopsSecurityException, ProvenanceException {
    if(trainingDatasetDTO == null){
