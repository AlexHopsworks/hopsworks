...
@XmlRootElement
public class ElasticFeatureDTO {
  ...
  public ElasticFeatureDTO() {
  }
  
  public ElasticFeatureDTO(String elasticId, String name, String featuregroup, Integer version, Integer parentProjectId,
